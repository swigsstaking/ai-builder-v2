      ...
      <div className="space-y-3">
        {DAYS_ORDERED.map(({ day, label }) => {
          ...
          return (
            ...
            >
              <div className="grid grid-cols-[44px_100px_1fr] items-center gap-x-4">
                {/* Toggle */}
                <button
                  type="button"
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className={`w-[110px] px-3 py-2 rounded-lg text-sm bg-white/[0.05] border border-white/[0.07] outline-none transition-colors ${
                      entry.enabled
              ...
              {/* Break row */}
              {entry.enabled && (
                <div className="grid grid-cols-[44px_100px_1fr] items-center gap-x-4 mt-3">
                  {/* Empty cells to align with toggle + label */}
                  <div />
                  <button
                    type="button"
                    onClick={() => updateDay(day, 'hasBreak', !entry.hasBreak)}
                    className={`flex items-center gap-1.5 text-xs px-2.5 py-1 rounded-md transition-colors w-fit ${
                      entry.hasBreak
                  ...
                  {entry.hasBreak ? (
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="w-[110px] px-3 py-2 rounded-lg text-sm bg-white/[0.05] border border-white/[0.07] text-white outline-none focus:border-amber-500 transition-colors"
                      />
