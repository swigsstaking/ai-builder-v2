                ...
                <div className="flex items-center justify-center">
                  {aboutData.imageMediaId ? (
                    ...
                    <div
                      ...
                      className="image-placeholder w-full h-64 rounded-2xl border-2 border-dashed border-gray-300 flex-col items-center justify-center gap-2 text-gray-400 cursor-pointer hover:border-gray-400 transition-colors"
                    >
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-6 flex justify-center">
              {heroPractitionerData.photoMediaId ? (
                ...
                <>
                  {/* Preview: subtle silhouette */}
                  <div
                    className="photo-silhouette w-32 h-32 rounded-full border-4 border-white/20 shadow-xl items-center justify-center"
                  ...
                  {/* Editor: dashed + clickable */}
                  <div
                    data-editable="photoMediaId"
                    className="photo-editor w-32 h-32 rounded-full border-2 border-dashed border-white/40 shadow-xl flex-col items-center justify-center gap-1 cursor-pointer hover:border-white/60 transition-colors"
